...
@misc.log_experiment
def experiment_distil_gaussian(dataset_name, n_epochs_gaussian, n_epochs_data, lr=1e-3, compare=False, verbose=True, LOG_DIR=LOG_DIR, desc=None, save=False, **kwargs):
    ...
    teacher_path = os.path.join(LOG_DIR, teacher_name)
